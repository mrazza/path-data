...
docker build -t registry.digitalocean.com/razza/server:v1.16 ../server/bin/Release/netcoreapp2.2/publish
docker push registry.digitalocean.com/razza/server:v1.16
